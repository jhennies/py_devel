...
from p161201_00_remove_small_objects import run_remove_small_objects
from p161201_01_merge_adjacent_objects import run_merge_adjacent_objects
from p161201_02_compute_feature_images import run_compute_feature_images
from p161201_03_find_border_contacts import run_find_border_contacts
from p161201_04_compute_paths import run_compute_paths
from p161201_05_features_of_paths import run_features_of_paths
...
if __name__ == '__main__':
    ...
    if params['run_remove_small_objects']:
        copy('p161201_00_remove_small_objects.py', params['scriptsfolder'])
        copy(yamlfile, paramfile_rso)
    if params['run_merge_adjacent_objects']:
        copy('p161201_01_merge_adjacent_objects.py', params['scriptsfolder'])
        copy(yamlfile, paramfile_mao)
    if params['run_compute_feature_images']:
        copy('p161201_02_compute_feature_images.py', params['scriptsfolder'])
        copy(yamlfile, paramfile_cfi)
    if params['run_find_border_contacts']:
        copy('p161201_03_find_border_contacts.py', params['scriptsfolder'])
        copy(yamlfile, paramfile_fbc)
    if params['run_compute_paths']:
        copy('p161201_04_compute_paths.py', params['scriptsfolder'])
