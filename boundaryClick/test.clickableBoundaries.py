...
class ClickablePathItem(QGraphicsPathItem):
    ...
    def set_path_from_coordinates(self, x, y):
        # TODO: Going back along the path to avoid creation of an area by the automatically closing path
        x_fwd = x
        x_rev = x_fwd[::-1]
...
class BoundaryViewer(Viewer):
    ...
    def __init__(self):
        ...
        # self.editor.posModel.connect(self, self.editor.posModel.slicingPositionChanged(), self.test)
    ...
    #         print event
    #         print obj
    #         print self.editor.posModel.slicingPos
    #     return Viewer.eventFilter(self, obj, event)
